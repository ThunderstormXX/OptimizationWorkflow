...
class TestRenderAnimation:
    ...
    def test_render_simple_animation(self, tmp_path: Path) -> None:
        """Test rendering a simple animation from synthetic trace."""
        ...
        out_gif = tmp_path / "animation.gif"
        config: dict[str, Any] = {
            "env": "gossip",
            "task": "logistic",
            "optimizer": "gd",
        ...
        assert out_gif.stat().st_size > 1000  # GIF should be at least 1KB
    ...
    def test_render_quadratic_animation(self, tmp_path: Path) -> None:
        ...
        out_gif = tmp_path / "quadratic.gif"
        config: dict[str, Any] = {
            "env": "single",
            "task": "quadratic",
            "optimizer": "fw",
        ...
        assert out_gif.exists()
        assert out_gif.stat().st_size > 1000
    ...
    def test_render_with_subsampling(self, tmp_path: Path) -> None:
        ...
        out_gif = tmp_path / "subsampled.gif"
        ...
        assert out_gif.exists()
        assert out_gif.stat().st_size > 500
    ...
    def test_empty_trace_no_crash(self, tmp_path: Path) -> None:
        ...
        # No GIF should be created for empty trace
...
class TestRunnerSingleModeAnimation:
    ...
    def test_single_mode_creates_animation(self, tmp_path: Path) -> None:
        """Test that single mode with --animate creates animation.gif and trace.jsonl."""
...
class TestRunnerMatrixModeAnimation:
    ...
    def test_matrix_mode_animates_top_k(self, tmp_path: Path) -> None:
        """Test that matrix mode with --animate creates animations for top-K runs."""
        workflow_dir = tmp_path / "workflow"
        workflow_dir.mkdir()
...
class TestCommGraphAndEdgePulsing:
    ...
    def test_render_with_comm_graph(self, tmp_path: Path) -> None:
        ...
        out_gif = tmp_path / "comm_animation.gif"
        config: dict[str, Any] = {
            "env": "gossip",
            "task": "logistic",
            "optimizer": "gd",
    ...
    def test_metadata_strings_logistic(self) -> None:
        ...
        assert "classification" in title_line1
    ...
    def test_metadata_strings_quadratic(self) -> None:
        ...
        assert "convex quadratic" in title_line1
        assert "L2(R=1.5)" in title_line2
