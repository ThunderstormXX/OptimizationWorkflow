...
METHOD=SFW-Ortho
GRID=configs/tuning/mnist_cnn/sfw_ortho_grid.json
CONFIG=${CONFIG:-configs/experiments/mnist_cnn.json}
TASK_DIR=${TASK_DIR:-configs/tasks/mnist_cnn}
WORKFLOW_DIR=${WORKFLOW_DIR:-workflow/tuning}
EPOCHS=${EPOCHS:-10}
NUM_RUNS=${NUM_RUNS:-3}
